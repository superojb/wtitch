...
const badgeVariants = cva(
  "inline-flex items-center rounded-[2px] border px-1.5 py-0.5 text-[9px] font-bold uppercase transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 font-mono leading-none",
  {
    variants: {
      variant: {
        default:
